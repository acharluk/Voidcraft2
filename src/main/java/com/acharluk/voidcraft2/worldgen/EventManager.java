package com.acharluk.voidcraft2.worldgen;
...
public class EventManager implements IWorldGenerator{
    ...
    private void generateEnd(World world, Random random, int x, int z) {
        //this.addOreSpawn(VBlock.voidOre, world, random, x, z, 16, 16, 4 + random.nextInt(3), 5, 15, 50);
        int Xcoord = x + random.nextInt(16);
        int Ycoord = 10 + random.nextInt(128);
        int Zcoord = z + random.nextInt(16);
        (new WorldGenEndMinable(VBlock.voidOre, 1 * ConfigurationHandler.OreSpawnMultiplier)).generate(world, random, Xcoord, Ycoord, Zcoord);
    }
